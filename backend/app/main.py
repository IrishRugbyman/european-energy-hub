...
def spreads_nonlinear_backtest(zone: str = "DE-LU"):
    ...
    return NonlinearBacktestResponse(
        ...
        lookahead=LookaheadPremium(**result["lookahead"]) if result.get("lookahead") else None,
...
def spreads_regime_aware_backtest(zone: str = "DE-LU"):
    ...
    return RegimeAwareBacktestResponse(
        ...
        source=result["source"],
        drought_pctile=result["drought_pctile"],
        drought_thr_pct=result["drought_thr_pct"],
        cost=result["cost"],
